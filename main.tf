# asagida ki kodlarin tamami - https://docs.microsoft.com/en-us/azure/developer/terraform/create-vm-cluster-with-infrastructure
# aldim ve kendimce degistirdim....
...
# asagida ki verileri - variable.tf icine nasil yazabilirim. 
provider "azurerm" {
  features {}
